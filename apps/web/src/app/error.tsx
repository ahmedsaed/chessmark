...
export default function GlobalError({
  ...
  return (
    <main className="mx-auto flex w-full max-w-[640px] flex-1 flex-col justify-center px-5 py-24">
      <p className="font-mono text-data uppercase tracking-[0.2em] text-bad">Error</p>
      ...
      {error.digest && (
        <p className="tabular mt-3 font-mono text-meta text-ink-faint">digest {error.digest}</p>
      )}
      <div className="mt-8">
        <button
          type="button"
