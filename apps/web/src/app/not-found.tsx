...
export default function NotFound() {
  return (
    <main className="mx-auto flex w-full max-w-[640px] flex-1 flex-col justify-center px-5 py-24">
      <p className="font-mono text-data uppercase tracking-[0.2em] text-ink-faint">404</p>
      ...
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        <Link
          href="/leaderboard"
          className="border border-line bg-surface px-3 py-1.5 font-mono text-data uppercase tracking-[0.14em] text-ink-dim transition-colors hover:border-accent-dim hover:text-ink"
        >
          Leaderboard
        </Link>
      </div>
