  ...
  return (
    <span className="flex items-center gap-2">
      <button
        type="button"
        onClick={copy}
        className="inline-flex min-h-11 items-center border border-line bg-surface px-3 py-1 font-mono text-data uppercase tracking-[0.1em] text-ink-faint transition-colors hover:border-accent-dim hover:text-ink sm:min-h-0 sm:px-2 sm:text-meta"
      >
